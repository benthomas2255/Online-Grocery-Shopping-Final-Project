...
<div class="controls">
<input type="text" placeholder="Enter category Name" pattern="[a-zA-Z]+" name="category" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<textarea class="span8" name="description"  pattern="[a-zA-Z]+" rows="5" ></textarea>
											</div>
										</div>
