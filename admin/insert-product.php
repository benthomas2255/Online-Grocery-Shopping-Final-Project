...
$sql=mysqli_query($con,"insert into products(category,subCategory,productName,productPrice,productDescription,shippingCharge,productAvailability,productImage1,quantity) values('$category','$subcat','$productname','$productprice','$productdescription','$productscharge','$productavailability','$productimage1','$quantity')");
...
<div class="controls">
<input type="number"    name="quantity" min=1 placeholder="Enter Product Quantity" class="span8 tip" required>
</div>
</div>
