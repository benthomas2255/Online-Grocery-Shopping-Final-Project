...
$sql=mysqli_query($con,"update  products set category='$category',subCategory='$subcat',productName='$productname',productPrice='$productprice',productDescription='$productdescription',shippingCharge='$productscharge',productAvailability='$productavailability',quantity='$quantity' where id='$pid' ");
...
<div class="controls">
<input type="number"    name="productprice"  min=1 placeholder="Enter Product Price" value="<?php echo htmlentities($row['productPrice']);?>" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<input type="number"    name="productShippingcharge"   min=0 placeholder="Enter Product Shipping Charge" value="<?php echo htmlentities($row['shippingCharge']);?>" class="span8 tip" required>
</div>
</div>
...
<div class="control-group">
<label class="control-label" for="basicinput">Update Quantity</label>
<div class="controls">
<input type="number"    name="quantity"  min=1 placeholder="Update Quantity" value="<?php echo htmlentities($row['quantity']);?>" class="span8 tip" required>
</div>
</div>
