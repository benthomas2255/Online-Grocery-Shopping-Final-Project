...
<p class="">Enter your Email id to reset your password</p>
<form class="register-form outer-top-xs" action="php/fpEmailValidation.php" method="post">
<span style="color:red;" >
		...
		<?php
					...
					?>
		    <label class="info-title" for="exampleInputEmail1">Email id  <span>*</span></label>
		    <input type="text" name="email" class="form-control unicase-form-control text-input" id="email"   onblur="myemail()" required  >
